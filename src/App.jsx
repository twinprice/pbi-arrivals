...
const RAW = [
  ...
  { id: "AA1071-1", type: "flight", display_name: "Joachim Chuah", origin_city: "Hartford", airline_code: "AA", flight_number: "5987", eta_sched: "2025-10-03T13:10:00-04:00", pickup: "MH/Carol" },
  { id: "AA1071-2", type: "flight", display_name: "Benedek Takacs", origin_city: "Hartford", airline_code: "AA", flight_number: "5987", eta_sched: "2025-10-03T13:10:00-04:00", pickup: "MH/Carol" },
  { id: "AA1071-3", type: "flight", display_name: "Low Wa Sern", origin_city: "Hartford", airline_code: "AA", flight_number: "5987", eta_sched: "2025-10-03T13:10:00-04:00", pickup: "MH/Carol" },
  { id: "AA1071-4", type: "flight", display_name: "Thanusaa Uthrian", origin_city: "Hartford", airline_code: "AA", flight_number: "5987", eta_sched: "2025-10-03T13:10:00-04:00", pickup: "MH/Carol" },
  { id: "AA1071-5", type: "flight", display_name: "Hannah Chukwu", origin_city: "Hartford", airline_code: "AA", flight_number: "5987", eta_sched: "2025-10-03T13:10:00-04:00", pickup: "MH/Carol" },
  { id: "AA1071-6", type: "flight", display_name: "Kara Lincou", origin_city: "Hartford", airline_code: "AA", flight_number: "5987", eta_sched: "2025-10-03T13:10:00-04:00", pickup: "MH/Carol" },
  { id: "AA1071-7", type: "flight", display_name: "Quincy Cline", origin_city: "Hartford", airline_code: "AA", flight_number: "5987", eta_sched: "2025-10-03T13:10:00-04:00", pickup: "MH/Carol" },
...
// ======== CACHE (localStorage) ========
const cacheKey = "flightCacheV2"

function readCacheObj() {
...
function readFromCacheIfFresh(flight, flightDate, maxAgeSec = CONFIG.CACHE_SECONDS) {
  const all = readCacheObj()
  const entry = all[cacheKeyFor(flight, flightDate)]
  if (!entry) return null
  if (Date.now() - entry.ts > maxAgeSec * 1000) return null
  return entry.payload
}
function writeCacheFor(flight, flightDate, payload) {
  const all = readCacheObj()
  all[cacheKeyFor(flight, flightDate)] = { ts: Date.now(), payload }
  writeCacheObj(all)
}
...
async function fetchTrainStatus(trainNumber) {
  ...
  try {
    ...
    return await res.json()   // expects { status, eta_est }
  } catch (e) {
    console.error("Train status fetch failed:", e)
    return null
  }
}
function normalizeAviationstackJson(apiJson, airlineIata, flightNumber) {
  const it = apiJson && apiJson.data && apiJson.data[0];
  if (!it) return { status: "Scheduled", eta_est: null };
